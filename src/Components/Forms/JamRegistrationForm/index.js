...
const JamRegistrationForm = ({ jamId, jamName, jammerId, invId, setJamId, setSection, setSubSection }) => {
...
export default connect(null, { setJamId, setSection, setSubSection})(JamRegistrationForm);